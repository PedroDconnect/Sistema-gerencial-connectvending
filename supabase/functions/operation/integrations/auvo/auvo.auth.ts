...
// A Auvo devolve "yyyy-MM-dd HH:mm:ss" sem timezone. Confirmado empiricamente
// (comparando com o header HTTP Date da própria resposta) que é horário de
// Brasília (UTC-3) — o Brasil não usa mais horário de verão desde 2019, então
// esse offset fixo é seguro.
