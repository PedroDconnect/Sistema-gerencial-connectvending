...
// Mesmo padrão de operation/shared/logger.ts — eventos técnicos
// (integration_events), nunca token/apiKey/apiToken. logEvent nunca
// lança: falha ao gravar auditoria não pode derrubar a resposta real.
